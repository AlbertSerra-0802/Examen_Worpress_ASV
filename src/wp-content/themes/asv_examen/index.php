...
<main>
        ...
        style="background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('<?php echo get_template_directory_uri(); ?>/assets/img/moon.jpg') no-repeat center center fixed; background-size: cover; min-height: 100vh;"        <div class="container">
                <div class="text-center mb-5">

                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/moon.svg" style="width: 60px;" class="mb-3 luna-azul">                    
                ...
                <div class="row align-items-center mx-auto"> 
                    ...
                    <div class="col-md-5 text-center mt-3 mt-md-0">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/astronauta.jpeg" alt="Astronauta" style="width: 250px; height: 230px; object-fit: cover;">
                    </div>
                </div>
            </div>
        </section>

    ...
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-md-4">
            <div class="p-4 rounded-3 border border-secondary bg-dark h-100">
                ...
                <p class="small text-light">Simulador interactivo del rover lunar utilizado en las misiones Apollo 15, 16 y 17.</p>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="p-4 rounded-3 border border-secondary bg-dark h-100">
                ...
                <p class="small text-light">Línea de tiempo interactiva que documenta todas las misiones del programa Apollo.</p>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="p-4 rounded-3 border border-secondary bg-dark h-100">
                ...
                <p class="small text-light">Experiencia de realidad virtual del alunizaje del Apollo 11.</p>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4 justify-content-center mt-2">
        <div class="col-md-4">
            <div class="p-4 rounded-3 border border-secondary bg-dark h-100">
                ...
                <p class="small text-light">Sistema de comunicación basado en el protocolo usado entre Houston y las misiones Apollo.</p>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="p-4 rounded-3 border border-secondary bg-dark h-100">
                ...
                <p class="small text-light">Aplicación educativa sobre el entrenamiento de astronautas del programa Apollo.</p>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="p-4 rounded-3 border border-secondary bg-dark h-100">
                ...
                <p class="small text-light">Visualización de datos de lanzamiento del cohete Saturn V.</p>
            </div>
        </div>
    </div>
